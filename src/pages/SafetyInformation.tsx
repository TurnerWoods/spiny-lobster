...
const tocItems: TOCItem[] = [
  { id: "about", title: "About Elevare Health" },
  { id: "off-label", title: "Off-Label & Compounded" },
  { id: "inform-clinician", title: "Always Inform Your Clinician" },
  { id: "interactions", title: "Medication Interactions" },
  { id: "testosterone", title: "Testosterone Therapy" },
  { id: "peptides", title: "Peptide Therapy" },
  { id: "nad", title: "NAD+ Therapy" },
  { id: "injectables", title: "Injectable Medications" },
  { id: "lab-testing", title: "Laboratory Testing" },
  { id: "safety-during", title: "Safety During Treatment" },
  { id: "reporting", title: "Reporting Reactions" },
...
const SafetyInformation = () => {
  return (
    <LegalPageLayout
      ...
      subtitle="Important information about treatments and medications"
      icon={AlertTriangle}
      tocItems={tocItems}
    >
      {/* Emergency Warning */}
      <Card className="border-2 border-destructive/40 bg-destructive/5 backdrop-blur-xl">
      ...
      {/* Important Notice */}
      <Card className="border-2 border-amber-500/40 bg-amber-500/5 backdrop-blur-xl">
        <CardContent className="p-6">
          <div className="flex items-start gap-4">
      ...
      <Card variant="glass" id="off-label">
        <CardContent className="p-6">
      ...
      <Card variant="glass" id="inform-clinician">
        <CardContent className="p-6">
          <h2 className="mb-4 font-display text-xl font-bold text-rich-black">Always Inform Your Clinician</h2>
          <p className="mb-4 text-warm-gray leading-relaxed">Before starting any treatment, you <strong className="text-rich-black">must</strong> inform your clinician of:</p>
      ...
      <Card variant="glass" id="interactions">
        <CardContent className="p-6">
          <h2 className="mb-4 font-display text-xl font-bold text-rich-black">Medication Interactions</h2>
          <p className="text-warm-gray leading-relaxed">Some therapies may interact with other medications or substances, including:</p>
      ...
      <Card variant="glass" id="testosterone">
        <CardContent className="p-6">
          ...
          <p className="mb-3 text-warm-gray leading-relaxed">Testosterone therapy may cause:</p>
          <ul className="ml-6 list-disc space-y-2 text-warm-gray">
      ...
      <Card variant="glass" id="peptides">
        <CardContent className="p-6">
          <div className="mb-4 flex items-center gap-3">
          ...
          <p className="mb-3 text-warm-gray leading-relaxed">Peptide therapies (Sermorelin, Tesamorelin, BPC-157, etc.) may cause:</p>
          <ul className="ml-6 list-disc space-y-2 text-warm-gray">
      ...
      <Card variant="glass" id="injectables">
        <CardContent className="p-6">
          <div className="mb-4 flex items-center gap-3">
          ...
          <p className="mb-3 text-warm-gray leading-relaxed">When using injectable medications:</p>
          <ul className="ml-6 list-disc space-y-2 text-warm-gray">
      ...
      <Card variant="glass" id="lab-testing">
        <CardContent className="p-6">
          <h2 className="mb-4 font-display text-xl font-bold text-rich-black">Laboratory Testing</h2>
          <p className="text-warm-gray leading-relaxed">Your clinician may require laboratory testing before or during treatment, including:</p>
          <ul className="ml-6 mt-3 list-disc space-y-2 text-warm-gray">
      ...
      <Card variant="glass" id="safety-during">
        <CardContent className="p-6">
      ...
      <Card variant="glass" id="reporting">
        <CardContent className="p-6">
      ...
      <Card variant="glass" id="questions">
        <CardContent className="p-6">
