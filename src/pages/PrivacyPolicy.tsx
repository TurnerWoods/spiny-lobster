          ...
          <div className="mx-auto max-w-4xl">
            ...
            >
              ...
              <div className="mb-8 flex items-center gap-4">
                ...
                <div>
                  <h1 className="font-display text-3xl font-bold text-rich-black sm:text-4xl">Privacy Policy</h1>
              ...
              <div className="space-y-6">
                ...
                <Card variant="glass">
                  <CardContent className="p-6">
                    ...
                    <p className="text-warm-gray">This Policy applies to all personal information collected through our Services, including:</p>
                ...
                <Card variant="glass">
                  <CardContent className="p-6">
                    ...
                    <p className="text-warm-gray">We use collected information to:</p>
                    <ul className="ml-6 mt-3 list-disc space-y-2 text-warm-gray">
                ...
                <Card variant="glass">
                  <CardContent className="p-6">
                    ...
                    <p className="text-warm-gray">We may share your information with:</p>
                    <ul className="ml-6 mt-3 list-disc space-y-2 text-warm-gray">
                ...
                <Card variant="glass">
                  <CardContent className="p-6">
                    ...
                    <p className="text-warm-gray">If you have questions about this Privacy Policy or our privacy practices, please contact us:</p>
