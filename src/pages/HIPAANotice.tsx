          ...
          <div className="mx-auto max-w-4xl">
            ...
            >
              ...
              <div className="mb-8 flex items-center gap-4">
                ...
                <div>
                  <h1 className="font-display text-3xl font-bold text-rich-black sm:text-4xl">HIPAA Notice of Privacy Practices</h1>
                  <p className="text-warm-gray">Effective Date: January 2025</p>
                </div>
              </div>

              {/* Summary Box */}
              <Card className="mb-8 border-2 border-warm-stone/30 bg-warm-stone/5 backdrop-blur-xl">
              ...
              <div className="space-y-6">
                <Card variant="glass">
                  <CardContent className="p-6">
                    ...
                    <p className="mb-4 text-warm-gray">When it comes to your health information, you have certain rights. You can:</p>
                    ...
                    <div className="space-y-4">
                      <div className="rounded-lg bg-soft-linen/50 p-4">
                        ...
                        <p className="text-sm text-warm-gray">You can ask to see or get an electronic or paper copy of your medical record and other health information we have about you. We will provide a copy or summary of your health information, usually within 30 days of your request. We may charge a reasonable, cost-based fee.</p>
                      </div>
                      
                      <div className="rounded-lg bg-soft-linen/50 p-4">
                        <h3 className="mb-1 font-semibold text-rich-black">Ask us to correct your health records</h3>
                        <p className="text-sm text-warm-gray">You can ask us to correct health information about you that you think is incorrect or incomplete. We may say "no" to your request, but we'll tell you why in writing within 60 days.</p>
                      </div>
                      
                      <div className="rounded-lg bg-soft-linen/50 p-4">
                        <h3 className="mb-1 font-semibold text-rich-black">Request confidential communications</h3>
                        <p className="text-sm text-warm-gray">You can ask us to contact you in a specific way (for example, home or office phone) or to send mail to a different address. We will consider all reasonable requests and must say "yes" if you tell us you would be in danger if we do not.</p>
                      </div>
                      
                      <div className="rounded-lg bg-soft-linen/50 p-4">
                        <h3 className="mb-1 font-semibold text-rich-black">Ask us to limit what we use or share</h3>
                        <p className="text-sm text-warm-gray">You can ask us not to use or share certain health information for treatment, payment, or our operations. We are not required to agree to your request, and we may say "no" if it would affect your care.</p>
                      </div>
                      
                      <div className="rounded-lg bg-soft-linen/50 p-4">
                        <h3 className="mb-1 font-semibold text-rich-black">Get a list of those with whom we've shared information</h3>
                        <p className="text-sm text-warm-gray">You can ask for a list (accounting) of the times we've shared your health information for six years prior to the date you ask, who we shared it with, and why. We will include all disclosures except for those about treatment, payment, and health care operations, and certain other disclosures.</p>
                      </div>
                      
                      <div className="rounded-lg bg-soft-linen/50 p-4">
                        <h3 className="mb-1 font-semibold text-rich-black">Get a copy of this privacy notice</h3>
                        <p className="text-sm text-warm-gray">You can ask for a paper copy of this notice at any time, even if you have agreed to receive the notice electronically. We will provide you with a paper copy promptly.</p>
                      </div>
                      
                      <div className="rounded-lg bg-soft-linen/50 p-4">
                        <h3 className="mb-1 font-semibold text-rich-black">Choose someone to act for you</h3>
                        <p className="text-sm text-warm-gray">If you have given someone medical power of attorney or if someone is your legal guardian, that person can exercise your rights and make choices about your health information. We will make sure the person has this authority and can act for you before we take any action.</p>
                      </div>
                      
                      <div className="rounded-lg bg-soft-linen/50 p-4">
                        <h3 className="mb-1 font-semibold text-rich-black">File a complaint if you feel your rights are violated</h3>
                        <p className="text-sm text-warm-gray">You can complain if you feel we have violated your rights by contacting us using the information at the end of this notice. You can also file a complaint with the U.S. Department of Health and Human Services Office for Civil Rights. We will not retaliate against you for filing a complaint.</p>
                      </div>
                    </div>
                  </CardContent>
                </Card>
                ...
                <Card variant="glass">
                  <CardContent className="p-6">
                    ...
                    <p className="mb-4 text-warm-gray">We typically use or share your health information in the following ways:</p>
                    
                    <div className="space-y-4">
                      <div className="rounded-lg bg-soft-linen/50 p-4">
                        <h3 className="mb-1 font-semibold text-rich-black">Treat You</h3>
                        <p className="text-sm text-warm-gray">We can use your health information and share it with other professionals who are treating you. <em>Example: A physician treating you for a condition asks another physician about your overall health condition.</em></p>
                      </div>
                      
                      <div className="rounded-lg bg-soft-linen/50 p-4">
                        <h3 className="mb-1 font-semibold text-rich-black">Run Our Organization</h3>
                        <p className="text-sm text-warm-gray">We can use and share your health information to run our practice, improve your care, and contact you when necessary. <em>Example: We use health information about you to manage your treatment and services.</em></p>
                      </div>
                      
                      <div className="rounded-lg bg-soft-linen/50 p-4">
                        <h3 className="mb-1 font-semibold text-rich-black">Bill for Your Services</h3>
                        <p className="text-sm text-warm-gray">We can use and share your health information to bill and get payment from health plans or other entities. <em>Example: We give information about you to your health insurance plan so it will pay for your services.</em></p>
                      </div>
                    </div>
                  </CardContent>
                </Card>
                ...
                <Card variant="glass">
                  <CardContent className="p-6">
                    ...
                    <p className="mb-4 text-warm-gray">We are allowed or required to share your information in other ways – usually in ways that contribute to the public good, such as public health and research. We have to meet many conditions in the law before we can share your information for these purposes.</p>
                ...
                <Card variant="glass">
                  <CardContent className="p-6">
                    ...
                    <p className="mb-4 text-warm-gray">For certain health information, you can tell us your choices about what we share. If you have a clear preference for how we share your information in the situations described below, talk to us.</p>
                ...
                <Card variant="glass">
                  <CardContent className="p-6">
                    ...
                    <p className="mb-4 text-warm-gray">If you have questions about this notice or our privacy practices, or if you want to exercise your rights, please contact:</p>
