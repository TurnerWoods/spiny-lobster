...
>(({ className, ...props }, ref) => (
  <CheckboxPrimitive.Root
    ref={ref}
    className={cn(
      "peer h-5 w-5 shrink-0 rounded-md border-2 border-warm-stone/30 bg-pure-white/60 ring-offset-background backdrop-blur-sm transition-all duration-200 ease-out",
